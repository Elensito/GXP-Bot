...
class Verify(commands.Cog):
    ...
    @app_commands.command(name="link", description="Sync all guild members and calculate Activity Points")
    ...
    @app_commands.command(name="fix", description="Recalculate all Activity Points from the database")
